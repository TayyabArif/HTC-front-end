    ...
    <Card className={classes.card} data-testid={'support_card'}>
      ...
      <CardContent classes={{ root: classes.content }}>
        <Box margin="0px 0px 25px 0px" padding={0} >
          <Link data-testid='knowledge_button' classes={{ root: classes.link }} onClick={() => window.open(process.env.REACT_APP_FTC_KNOWLEDGE_BASE_SUPPORT, '_blank', 'noopener,noreferrer')}>

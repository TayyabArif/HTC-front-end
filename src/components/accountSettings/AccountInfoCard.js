...
export const AccountInfoCard = props => {
  ...
  //   store.dispatch(
  //     authActions.setUser({
  //       ...{ token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..VTsLoKwCa_34fIBBLlTKWXqchcNMB4bBaaNFhMQpMeY' },
  //       userInfo: {
  ...
  //         updatedAt: '2022-11-23T16:48:42.254Z',
  //         lastAccessed: 1669222122,
  //         ftc_role: '',
  //         role: 'installer',
